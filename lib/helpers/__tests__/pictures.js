...
describe('pictures', () => {
  ...
  describe('default', () => {
    it('pictureFullUrl is the source', async () => {
      const input = {
        preview: {
          images: [
            {
    ...
    it('pictureUrl is the one with the closest width', async () => {
      const minWidth = 600;
      const input = {
        preview: {
          images: [
  ...
  describe('gallery', () => {
    it('pictureFullUrl is the url of the first element in the gallery', async () => {
      const input = {
        gallery_data: {
          items: [
            {
